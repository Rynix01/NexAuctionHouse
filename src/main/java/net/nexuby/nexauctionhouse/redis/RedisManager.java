...
public class RedisManager {
    ...
    public boolean connect() {
        ...
        String secret = config.getRedisMessageSecret();
        ...
        try {
            DefaultJedisClientConfig.Builder clientConfig = DefaultJedisClientConfig.builder()
                    ...
                    .database(database)
                    .ssl(config.getRedisSSL());
            if (password != null && !password.isEmpty()) clientConfig.password(password);
            this.pool = new JedisPool(poolConfig, new HostAndPort(host, port), clientConfig.build());
            ...
            public void onMessage(String ch, String message) {
                try {
                    ...
                    if (verified != null) {
                        ...
                        plugin.getLogger().warning("Rejected invalid or replayed Redis message on " + ch);
                    }
                } catch (Exception e) {
